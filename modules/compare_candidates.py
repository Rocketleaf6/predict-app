#!/usr/bin/env python3
"""Compare candidates module rendered from the main app."""
...
def render() -> None:
    ...
    fig = px.bar(chart_df, x="Composite", y="Score", color="DOB", barmode="group", text=chart_df["Score"].map(lambda x: f"{x:.1f}"))
